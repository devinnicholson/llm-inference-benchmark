...
| --- | ---: | --- | --- |
| Control direct counter hit rate | 1.343% | n/a | Matched unique-prefix baseline stays low after the no-repeat prompt audit. |
| Shared direct counter hit rate | 91.229% | n/a | Shared-prefix workload triggers measured-window KV reuse. |
| Shared-minus-control direct counter delta | 89.885 pp | 89.867 pp to 89.909 pp | Stable positive reuse effect; interval is far above zero. |
