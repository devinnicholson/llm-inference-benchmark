...
| --- | ---: | --- | --- |
| Control direct counter hit rate | 4.716% | n/a | Matched unique-prefix baseline stays low after the no-repeat prompt audit. |
| Shared direct counter hit rate | 83.138% | n/a | Shared-prefix workload triggers measured-window KV reuse. |
| Shared-minus-control direct counter delta | 78.422 pp | 78.269 pp to 78.602 pp | Stable positive reuse effect; interval is far above zero. |
